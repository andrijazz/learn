...
We are introducing $ReLU$ (Rectified Linear Unit) function which is often seen in deep learning literature.
\begin{align}
f(x) =
	\begin{cases}
		x   & \quad x \geq 0\\
...
% TODO implement ReLU function in python, plot it and add the plotted png here
%\begin{figure}
